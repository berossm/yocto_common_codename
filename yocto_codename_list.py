...
names = ["inky", "clyde", "blinky", "pinky", "purple", "green", "laverne",
         ...
         "zeus", "dunfell", "gatesgarth", "hardknott", "honister",
         "kirkstone", "langdale", "mickledore", "nanbield",
         "scarthgap"]

last_major = 5

versions = {"inky": 0.3, "clyde": 0.4, "blinky": 0.5, "pinky": 0.6, "purple": 0.7, "green": 0.8, "laverne": 0.9,
            "bernard": 1.0, "edison": 1.1, "denzil": 1.2, "danny": 1.3, "dylan": 1.4, "dora": 1.5, "daisy": 1.6, "dizzy": 1.7, "fido": 1.8,
            "jethro": 2.0, "krogoth": 2.1, "morty": 2.2, "pyro": 2.3, "rocko": 2.4, "sumo": 2.5, "thud": 2.6, "warrior": 2.7,
